        ...
        <div className={styles.container}>
          ...
          <div className={styles.price_chooser}>
            <div className={styles.price_choose} cont="1" onClick={tarif}>
              <h3 className={`${styles.price_title} tarif_choosed`}>Год</h3>
            </div>
          ...
          <div className={styles.price_cards}>
            <div className={styles.price_card}>
              <h4 className={styles.card_title}>Бесплатно</h4>
              <h1 className={styles.card_price}>0<span>&#8381;</span></h1>
              <div className={styles.card_pluses}></div>
